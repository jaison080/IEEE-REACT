...
function Landing() {
  return (
    ...
    <div className='container' id="centre_mobile">
      <div className="row" id="contact">
        <div className="col s12 m4 l4" id='dupar_margin'>
          ...
          <div class="card light-blue darken-4 z-depth-1">
    ...
    <div class="col s12 m12 l12" id='upar_margin'>
      <div class="card blue darken-2 z-depth-4">
        <div class="card-content white-text">
    ...
    <div class="col s12 m4 margin_top_mobile card light-blue darken-4 z-depth-1" id='upar_margin'>
      <div class="card-content white-text">
